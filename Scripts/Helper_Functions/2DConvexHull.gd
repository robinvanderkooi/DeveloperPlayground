...
static func Vector3ArrayToHull(point_array:Array) -> Array:
	...
	resulting_array.append_array( Vector3ArrayToHull_side(point_minX, point_maxX, new_point_array) )
	resulting_array.append_array( Vector3ArrayToHull_side(point_maxX, point_minX, new_point_array) )
	return resulting_array

static func Vector3ArrayToHull_side(point_left:Vector3, point_right:Vector3, point_array:Array) -> Array:
	...
	var resulting_array:Array = Array()
	resulting_array.append_array( Vector3ArrayToHull_side(point_left, farthest_point, new_point_array) )
	resulting_array.append_array( Vector3ArrayToHull_side(farthest_point, point_right, new_point_array) )
	return resulting_array
